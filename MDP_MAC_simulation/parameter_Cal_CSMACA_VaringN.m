...
ind_node= 1;
% NumUP = 4;
for NumUP = 2:2:16%   多种优先级情况下
%     len_RAP = TB;
    indE = indE + 1;
%   -------------设置节点的优先级----------------------------
    UPclass= [UP_high,UP_low];%0,,4,7     %使用混合的优先级配置，WBAN中优先级种类     
...
%         tic
        [ReTX_time_pre,Def_Time_Pre,CSMA_Sta_Pre,TDMA_CHN_Sta,PL_RAP,PS_RAP,Colli_RAP,ELE_RAP,Succ_TX_time_RAP,E_overflow_RAP,EH_RAP,E_buff] = slotCSMACA_unsat(len_RAP,CSMA_Sta_Pre,Def_Time_Pre,RAP_CHN_Sta,ReTX_time_pre,CW,last_TX_time_RAP,lambdaE,E_buff);
%         toc
...
% save('CSMACA_unsat(UP0,E0.05-B0.05,N2-12,Em20-Bm20).mat');
% save('noMDP_unsat(UP0,E0.05-B0.05,N2-12,Em20-Bm20).mat');

%% ----------------------
% save('staticpara_CSMACA_VaringN(UPH3-UPL0,NH1-E0.1)(NL2-2-12).mat','Sk','
% Ek');

%% second research point
% save('CSMACA_VaringN(UPH0-UPL0,NH4-E0.05)(NL0-2-12).mat');