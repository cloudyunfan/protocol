...
indE = 0;
NumUP = 6;
for lambdaE = 0.02:0.02:0.12%   多种优先级情况下
    indE = indE + 1;
%   -------------设置节点的优先级----------------------------
...
%% ----------------------
% save('staticpara_CSMACA_VaringE(UPH3-UPL0,NH4-NL6)(E0.02-0.02-0.12).mat','Sk','Ek');

%% ---second research point
save('CSMACA_VaringE(UPH0-UPL0,NH4-NL6)(E0.02-0.02-012).mat');