function [ReTX_time,backoff_after,CSMA_sta,pl_t,ps_t,PL_colli,TX_time] = slotCSMACA_unsat_new(rap_length,CSMA_sta,def_time_pre,last_CHN_sta,ReTX_times_pre,CW,last_TX_time,E_buff) %act,,B_buff
